...
class Message extends Base {
    ...
    async sendFileUrl  (jid, url, caption, quoted, options = {}) => {
      ...
      if (mime.split("/")[1] === "gif") {
     return this.client.sendMessage(this.jid, { video: await getBuffer(url), caption: caption, gifPlayback: true, ...options}, { quoted: quoted, ...options})
      }
      let type = mime.split("/")[0]+"Message"
      if(mime === "application/pdf"){
     return this.client.sendMessage(this.jid, { document: await getBuffer(url), mimetype: 'application/pdf', caption: caption, ...options}, { quoted: quoted, ...options })
      }
      if(mime.split("/")[0] === "image"){
     return this.client.sendMessage(this.jid, { image: await getBuffer(url), caption: caption, ...options}, { quoted: quoted, ...options})
      }
      if(mime.split("/")[0] === "video"){
     return this.client.sendMessage(this.jid, { video: await getBuffer(url), caption: caption, mimetype: 'video/mp4', ...options}, { quoted: quoted, ...options })
      }
      if(mime.split("/")[0] === "audio"){
     return this.client.sendMessage(this.jid, { audio: await getBuffer(url), caption: caption, mimetype: 'audio/mpeg', ...options}, { quoted: quoted, ...options })
      }
      }
    ...
    async sendMessage(
        content,
        opt = {
            packname: "Xasena", author: "X-electra"
        },
        type = "text"
    ) {
